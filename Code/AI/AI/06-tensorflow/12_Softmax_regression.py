...
# W将784输入转为10输出，矩阵乘法：A列 = B行，结果：A行 * B列
W = tf.Variable(tf.zeros([784, 10]))
b = tf.Variable(tf.zeros([10]))     # 截距
...
# 评估
# tf.argmax()是一个从tensor中寻找最大值的索引，tf.argmax就是求各个预测的数字中概率最大的那一个
