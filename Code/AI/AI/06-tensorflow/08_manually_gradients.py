...
scaler = StandardScaler().fit(housing_data_plus_bias)       # 计算归一化因子
scaled_housing_data_plus_bias = scaler.transform(housing_data_plus_bias)# 计算归一化结果
